 ...
 */
package com.example.module_commonview.wheelview.yuri.wheelview.adapter;
...
public abstract class AbstractWheelTextAdapter1 extends AbstractWheelAdapter {
    ...
    public static final int selected_text_color = 0xffff0000;
    public static final int un_selected_text_color = Color.BLACK;
    public static final int selected_text_size = 20;

    public static final int un_selected_text_size = 12;
...
//                textView.setText(text + label);
                ...
                if (index == currentIndex) {
                    ...
                    textView.setTextSize(un_selected_text_size);
                    textView.setTextColor(un_selected_text_color);
                }
...
//            ((TextView) convertView).setTextSize(maxsize);
//            ((TextView) convertView).setTextColor(0xffff0000);
//        } else {
//            ((TextView) convertView).setTextSize(minsize);
