...
package com.example.module_commonview.wheelview.yuri.wheelview;
...
import com.example.module_commonview.wheelview.yuri.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View {
  ...
  private int[] SHADOWS_COLORS = new int[]{0xFFFFFFFF, 0x00FFFFFF, 0x00FFFFFF};
    ...
    // Wheel drawables
    private int wheelBackground = R.drawable.ic_launcher_background;
    private int wheelForeground = R.drawable.ic_launcher_background;
     ...
     * Actual amount of visible items depends openFlashlight wheel layout parameters.
    ...
    /**
     * Draws shadows openFlashlight top and bottom of control
     *
