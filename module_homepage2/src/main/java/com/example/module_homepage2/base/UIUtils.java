...
//    public static void setClickableTextView(String normalText, String clickText, final View.OnClickListener listener, final TextView textView) {
//        if (TextUtils.isEmpty(clickText) && TextUtils.isEmpty(normalText)) return;
...
//                ds.setColor(textView.getContext().getResources().getColor(R.color.global_blue));
//                ds.setUnderlineText(false);
//                ds.clearShadowLayer();
//            }
//        };
//        SpannableStringBuilderSuper spannableStringBuilderSuper = new SpannableStringBuilderSuper();
//        spannableStringBuilderSuper.append(TextFormatUtils.ensureNullToEmpty(normalText));
//        spannableStringBuilderSuper.appendSpannable(clickText, clickableSpan);
//        textView.setText(spannableStringBuilderSuper);
//        textView.setMovementMethod(AntiSelectionLineClickableSpan.getInstance());
...
//    }
    ...
    public static int calculateWidthFromFontSizeAndPadding(Context context, float paddding) {
        return (int) (UIUtils.calculateWidthFromFontSize(
                "占位占位占位占位",
                context.getResources().getDimensionPixelOffset(
                        R.dimen.font_smaller)) + paddding * 2);
    }
