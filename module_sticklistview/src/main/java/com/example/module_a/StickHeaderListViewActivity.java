...
import com.example.module_a.adapter.TravelingAdapter;
import com.example.module_a.model.ChannelEntity;
import com.example.module_a.model.FilterData;
...
import com.example.module_a.model.TravelingEntity;
import com.example.module_a.util.ColorUtil;
import com.example.module_a.util.DensityUtil;
import com.example.module_a.util.ModelUtil;
import com.example.module_a.util.StatusBarUtil;
import com.example.module_a.view.FilterView;
import com.example.module_a.view.HeaderBannerView;
import com.example.module_a.view.HeaderChannelView;
import com.example.module_a.view.HeaderDividerView;
import com.example.module_a.view.HeaderFilterView;
import com.example.module_a.view.HeaderOperationView;
import com.example.module_a.view.SmoothListView.SmoothListView;

import java.util.ArrayList;
import java.util.List;

public class StickHeaderListViewActivity extends AppCompatActivity implements SmoothListView.ISmoothListViewListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stick_header_list);
//        ButterKnife.bind(this);
        smoothListView = findViewById(R.id.listView);
        realFilterView = findViewById(R.id.real_filterView);
        ...
        flActionMore = findViewById(R.id.fl_action_more);
