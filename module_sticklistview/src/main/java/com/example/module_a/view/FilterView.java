...
import com.example.module_a.adapter.FilterLeftAdapter;
import com.example.module_a.adapter.FilterOneAdapter;
import com.example.module_a.adapter.FilterRightAdapter;
...
//        ButterKnife.bind(this, view);
        ...
        tvSortTitle = view.findViewById(R.id.tv_sort_title);
        ivSortArrow = view.findViewById(R.id.iv_sort_arrow);
        ...
        llSort = view.findViewById(R.id.ll_sort);
        llFilter = view.findViewById(R.id.ll_filter);
        lvLeft = view.findViewById(R.id.lv_left);
        lvRight = view.findViewById(R.id.lv_right);
        llHeadLayout = view.findViewById(R.id.ll_head_layout);
        llContentListView = view.findViewById(R.id.ll_content_list_view);
