...
import exocr.idcard.IDCardManager.IDCallBack
import kotlinx.android.synthetic.main.activity_old_scan.*
import java.io.File

class IdCardScan2Activity:AppCompatActivity(), IDCardManager.IDCallBack {
...
//            data_edt_id.setText(result.validdate);
    ...
    override fun onRecFailed(i: Int, p1: Bitmap?) {
        if (i == IDCallBack.CARD_CODE_FAIL) {
            Toast.makeText(this, "识别失败", Toast.LENGTH_SHORT).show()
        } else if (i == IDCallBack.CARD_CODE_TIMEOUT) {
